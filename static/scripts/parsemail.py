...
class Attachment:
    ...
    def __init__(self, part=None, filename=None, type=None, payload=None, charset=None, content_id=None, description=None, disposition=None, sanitized_filename=None, is_body=None):
    ...
    def getmailaddresses(self,msg, name):
    ...
    def get_filename(self,part):
        ...
        if filename and isinstance(filename, str):
            ...
            filename=self.getmailheader(filename)
